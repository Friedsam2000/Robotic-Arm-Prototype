...
R = 98;                //  Amount of teeth in the ring
P = 42;                 //  Amount of teeth in the planets
S = 14;                 //  Amount of teeth in the sun

play = 0.02;           //  Play between the parts

pitch = 2.25;           //  The pitch of the gears
pAngle = 35;            //  The pressure angle of the gears
thicknessGear = 7;      //  The thickness of the gears
...
extraRingHeight = 0;  //  The extra height of the ring gear for the screwholes
screwThreadRadius = 2;  //  Radius of the screw holes
amountScrews = 2;       //  Amount of screw holes
thickness = 3;      //  Wall thickness of the parts

planetAxRadius = 11.1;     //  Radius of the ax coming out of the planets
planetAxHeight = 7;     //  Radius of the ax coming out of the planets
