classdef Trajectory < handle
    ...
    properties
        virtualRobot; % Reference to the virtualRobot object
    ...
    methods
        %% Constructor
        function obj = Trajectory(virtualRobot)
        ...
        function initTrajectoryPlot(obj)
            obj.Index = 1;
            initialEEPos = obj.virtualRobot.forwardKinematics();
            obj.Points(:, :) = repmat(initialEEPos, 1, obj.Length);
        ...
        function updateTrajectoryPlot(obj)
            newEEPos = obj.virtualRobot.forwardKinematics();
            obj.Points(:, obj.Index) = newEEPos;
